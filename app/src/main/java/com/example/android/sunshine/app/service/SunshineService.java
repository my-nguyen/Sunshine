...
public class SunshineService extends IntentService {
   ...
   private String[] getWeatherDataFromJson(String forecastJsonStr, String locationSetting)
      ...
      try {
         ...
         if ( cVVector.size() > 0 ) {
            ...
            // transfer from Vector<ContentValues> to ContentValues[], in order to call
            // ContentResolver.bulkInsert()
            ContentValues[] valuess = new ContentValues[cVVector.size()];
            cVVector.toArray(valuess);
            inserted = getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, valuess);
         }
   ...
   long addLocation(String locationSetting, String cityName, double lat, double lon) {
      ...
      long id;
      // query via ContentResolver, just like in TestProvider
      ...
      if (cursor.moveToFirst()) {
         ...
         Uri insertedUri = getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, values);
